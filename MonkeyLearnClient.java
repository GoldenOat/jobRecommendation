...
import com.jobRecommendation.job.entity.ExtractRequestBody;
import com.jobRecommendation.job.entity.ExtractResponseItem;
import com.jobRecommendation.job.entity.Extraction;
import com.jobRecommendation.job.entity.ExtractRequestBody;
import com.jobRecommendation.job.entity.ExtractResponseItem;
import com.jobRecommendation.job.entity.Extraction;
...
public class MonkeyLearnClient {
    ...
    private static final String AUTH_TOKEN = "03a5e28a7d4775327841f6957b28b385bb1a296c";
    ...
    public static void main(String[] args) {
        ...
        List<String> articles = Arrays.asList(
                "<p dir=\"ltr\" style=\"line-height: 1.38; margin-top: 0pt; margin-bottom: 0pt;\"><span style=\"background-color: transparent; color: #000000; white-space: pre-wrap;\">Onko Health is hiring a full-stack engineer for our cancer support platform, becoming technical lead for our all-new team.</span></p>\n");
