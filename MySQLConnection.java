...
public class MySQLConnection {
    ...
    public MySQLConnection() {
        try {
            ...
            conn = DriverManager.getConnection(com.jobRecommendation.job.db.MySQLDBUtil.URL);
    ...
    public void saveItem(Item item) {
        ...
        try {
            ...
            statement.setString(4, item.getCompany_logo());
            statement.setString(5, item.getUrls());
